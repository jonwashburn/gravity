...
\section{Methods}
% Diagnostics moved to Appendix~\ref{app:robustness}; see there for cross-validation, bootstrap, residual tests, and error inflation checks.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\linewidth]{figs/ddo154_residuals.pdf}\hfill
  \includegraphics[width=0.45\linewidth]{figs/ngc3198_residuals.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\linewidth]{figs/ddo154_curve.pdf}\hfill
  \includegraphics[width=0.45\linewidth]{figs/ngc3198_curve.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\linewidth]{figs/btfr.pdf}\hfill
  \includegraphics[width=0.45\linewidth]{figs/rar.pdf}
